...
> 最后更新：2026-09-05
> 最新版本：**v3.4.4/408（2026-09-05 已发版 svg 通道，commit `ca8d027`）**：①SIGTRAP 崩溃根治（渲染吃快照）②用量卡长按单卡隐藏 ③AI 长回复多气泡截断省略号根治（MarkdownRenderer `.fixedSize`）④版本号双处一致；IPA 已校验 3.4.4/408，md5 `0b148909b6299dcd8f83ec927acd0e4e` 已转存 NAS `轻聊app/qingliao-3.4.4-unsigned.ipa`
