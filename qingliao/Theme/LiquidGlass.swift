...
//   · v3.9.16 登记：生活页「备忘录」卡是有意的自定义形态——圆角仍 16、描边仍 0.8pt/0.08，
//     但背景换成 MemoPaper（横线纸，见 MemoSection.swift）、且**不加阴影**（与全站平卡一致）；
//     下一位按本注释回改前先看一眼 MemoSection，别把纸底改回 dashboardCard
